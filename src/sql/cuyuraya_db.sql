CREATE DATABASE SISTEMAGESTIONAGUA;

USE SISTEMAGESTIONAGUA;
...
CREATE TABLE TBL_TARIFA (
  ...
  M3_CONSUMO DECIMAL(10,2) NOT NULL,
  MONTO_EXTRA_POR_M3 DECIMAL(10,2) NOT NULL,
  ESTADO VARCHAR(20) NOT NULL,
  FEC_CREACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FEC_ACTUALIZACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE TBL_LECTURA (
  ...
  LECTURA_ACTUAL DECIMAL(10,3) NOT NULL,
...
INSERT INTO TBL_TARIFA (COD_TARIFA, DESCRIPCION, MONTO_TARIFA, M3_CONSUMO, MONTO_EXTRA_POR_M3, ESTADO) VALUES ('BASE', 'Tarifa base', 5.0, 5.0, 1.0, 'ACTIVO');
...
-- Insertar los tipos de movimientos
INSERT INTO TBL_TIPO_MOVIMIENTO (CONCEPTO, ID_RUBRO, ESTADO) VALUES ('Pago de Recibo', 1, 'ACTIVO');
...
INSERT INTO TBL_USUARIO (NOMBRES, PATERNO, MATERNO, DNI, DIRECCION, CLAVE, ESTADO) VALUES ('Administrador', 'Administrador', 'Administrador', '12345678', 'EAS', 'asfa$adsf$', 'ACTIVO');
