...
CREATE TABLE TBL_UBIGEO (
  ...
  CONSTRAINT FK_UBIGEO_DEPARTAMENTO FOREIGN KEY (ID_DEPARTAMENTO) REFERENCES TBL_DEPARTAMENTO(ID_DEPARTAMENTO),
  CONSTRAINT FK_UBIGEO_PROVINCIA FOREIGN KEY (ID_PROVINCIA) REFERENCES TBL_PROVINCIA(ID_PROVINCIA),
  CONSTRAINT FK_UBIGEO_DISTRITO FOREIGN KEY (ID_DISTRITO) REFERENCES TBL_DISTRITO(ID_DISTRITO),
