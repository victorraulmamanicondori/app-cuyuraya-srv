...
CREATE TABLE TBL_SECTOR (
  ...
  NOMBRE VARCHAR(100) NOT NULL,
  COD_COMUNIDAD_CAMPESINA VARCHAR(10) NOT NULL,
  CONSTRAINT FK_SECTOR_COMUNIDAD_CAMPESINA FOREIGN KEY (COD_COMUNIDAD_CAMPESINA) REFERENCES TBL_COMUNIDAD_CAMPESINA(CODIGO)
);
...
CREATE TABLE TBL_UBIGEO (
  ...
  COD_COMUNIDAD_NATIVA VARCHAR(10),
  CONSTRAINT FK_UBIGEO_DISTRITO FOREIGN KEY (COD_DISTRITO) REFERENCES TBL_DISTRITO(CODIGO),
  CONSTRAINT FK_UBIGEO_CENTRO_POBLADO FOREIGN KEY (COD_CENTRO_POBLADO) REFERENCES TBL_CENTRO_POBLADO(CODIGO),
  CONSTRAINT FK_UBIGEO_COMUNIDAD_CAMPESINA FOREIGN KEY (COD_COMUNIDAD_CAMPESINA) REFERENCES TBL_COMUNIDAD_CAMPESINA(CODIGO),
  CONSTRAINT FK_UBIGEO_COMUNIDAD_NATIVA FOREIGN KEY (COD_COMUNIDAD_NATIVA) REFERENCES TBL_COMUNIDAD_NATIVA(CODIGO),
