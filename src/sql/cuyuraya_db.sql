...
CREATE TABLE TBL_PROVINCIA (
  ...
  NOMBRE VARCHAR(255) NOT NULL,
  CONSTRAINT PK_PROVINCIA PRIMARY KEY (COD_DEPARTAMENTO, COD_PROVINCIA),
  CONSTRAINT FK_PROVINCIA_DEPARTAMENTO FOREIGN KEY (COD_DEPARTAMENTO) REFERENCES TBL_DEPARTAMENTO(COD_DEPARTAMENTO)
);
...
CREATE TABLE TBL_DISTRITO (
  ...
  NOMBRE VARCHAR(255) NOT NULL,
  CONSTRAINT PK_DISTRITO PRIMARY KEY (COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO),
  CONSTRAINT FK_DISTRITO_PROVINCIA FOREIGN KEY (COD_DEPARTAMENTO, COD_PROVINCIA) REFERENCES TBL_PROVINCIA(COD_DEPARTAMENTO, COD_PROVINCIA)
);
...
CREATE TABLE TBL_CENTRO_POBLADO (
  ...
  COD_PROVINCIA VARCHAR(2) NOT NULL,
  COD_DISTRITO VARCHAR(2) NOT NULL,
  CONSTRAINT FK_CENTRO_POBLADO_DISTRITO FOREIGN KEY (COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO) REFERENCES TBL_DISTRITO(COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO)
);
...
CREATE TABLE TBL_COMUNIDAD_CAMPESINA (
  ...
  COD_PROVINCIA VARCHAR(2) NOT NULL,
  COD_DISTRITO VARCHAR(2) NOT NULL,
  CONSTRAINT FK_COMUNIDAD_CAMPESINA_DISTRITO FOREIGN KEY (COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO) REFERENCES TBL_DISTRITO(COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO)
);
...
CREATE TABLE TBL_SECTOR (
  ...
  NOMBRE VARCHAR(100) NOT NULL,
  ID_COMUNIDAD_CAMPESINA INT NOT NULL,
...
CREATE TABLE TBL_UBIGEO (
  ...
  CONSTRAINT FK_UBIGEO_DISTRITO FOREIGN KEY (COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO) REFERENCES TBL_DISTRITO(COD_DEPARTAMENTO, COD_PROVINCIA, COD_DISTRITO),
  CONSTRAINT FK_UBIGEO_CENTRO_POBLADO FOREIGN KEY (ID_CENTRO_POBLADO) REFERENCES TBL_CENTRO_POBLADO(ID_CENTRO_POBLADO),
  CONSTRAINT FK_UBIGEO_COMUNIDAD_CAMPESINA FOREIGN KEY (ID_COMUNIDAD_CAMPESINA) REFERENCES TBL_COMUNIDAD_CAMPESINA(ID_COMUNIDAD_CAMPESINA),
  CONSTRAINT FK_UBIGEO_SECTOR FOREIGN KEY (ID_SECTOR) REFERENCES TBL_SECTOR(ID_SECTOR)
);
...
CREATE TABLE TBL_USUARIO (
  ...
  FEC_CREACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  FEC_ACTUALIZACION TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT FK_USUARIO_UBIGEO FOREIGN KEY (ID_UBIGEO) REFERENCES TBL_UBIGEO(ID_UBIGEO)
);
