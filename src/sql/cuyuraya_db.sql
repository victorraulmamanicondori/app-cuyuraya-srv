...
CREATE TABLE TBL_PROVINCIA (
  ...
  CONSTRAINT FK_PROVINCIA_DEPARTAMENTO FOREIGN KEY (COD_DEPARTAMENTO) REFERENCES TBL_DEPARTAMENTO(CODIGO)
);
...
CREATE TABLE TBL_DISTRITO (
  ...
  CONSTRAINT FK_DISTRITO_PROVINCIA FOREIGN KEY (COD_PROVINCIA) REFERENCES TBL_PROVINCIA(CODIGO)
);
...
CREATE TABLE TBL_CENTRO_POBLADO (
  ...
  CONSTRAINT FK_CENTRO_POBLADO_DISTRITO FOREIGN KEY (COD_DISTRITO) REFERENCES TBL_DISTRITO(CODIGO)
);
...
CREATE TABLE TBL_COMUNIDAD_CAMPESINA (
  ...
  NOMBRE VARCHAR(100) UNIQUE NOT NULL,
  COD_DISTRITO INT NOT NULL,
  CONSTRAINT FK_COMUNIDAD_CAMPESINA_DISTRITO FOREIGN KEY (COD_DISTRITO) REFERENCES TBL_DISTRITO(CODIGO)
);
...
CREATE TABLE TBL_UBIGEO (
  ...
  CONSTRAINT FK_UBIGEO_DEPARTAMENTO FOREIGN KEY (COD_DEPARTAMENTO) REFERENCES TBL_DEPARTAMENTO(CODIGO),
  CONSTRAINT FK_UBIGEO_PROVINCIA FOREIGN KEY (COD_PROVINCIA) REFERENCES TBL_PROVINCIA(CODIGO),
  CONSTRAINT FK_UBIGEO_DISTRITO FOREIGN KEY (COD_DISTRITO) REFERENCES TBL_DISTRITO(CODIGO),
